...
#importiert die filedialog bibliothek von tkinter
from tkinter.filedialog import askopenfilename, asksaveasfilename

#öffnet ein window und setzt den namen, min größe beim Aufruf und ob der Inhalt mit vergrößern des Fensters wächst
window = tk.Tk()
